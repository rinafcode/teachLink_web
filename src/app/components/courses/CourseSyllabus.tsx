    ...
    <div className="bg-white dark:bg-[#1E293B] rounded-xl shadow-sm border border-[#E2E8F0] dark:border-[#334155] p-6 lg:p-8 mb-6 lg:mb-8">
      ...
      <div className="space-y-3">
        {sections.map((section) => (
          <div
            key={section.id}
            className="border border-[#E2E8F0] dark:border-[#334155] rounded-lg overflow-hidden transition-all duration-200"
          >
            <button
            ...
            >
              <div className="flex-1">
                <h3 className="font-semibold text-base lg:text-lg text-[#0F172A] dark:text-white">
                  {section.title}
                </h3>
                ...
                {section.lessons.map((lesson) => (
                  ...
                  >
                    <div className="flex items-center gap-3 flex-1">
                      ...
                      <span className="text-sm lg:text-base text-[#0F172A] dark:text-white group-hover:text-[#0066FF] dark:group-hover:text-[#00C2FF] transition-colors">
                        {lesson.title}
                      </span>
                      {lesson.preview && (
