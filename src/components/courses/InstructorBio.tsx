    ...
    <div className="bg-white dark:bg-[#1E293B] rounded-xl shadow-sm border border-[#E2E8F0] dark:border-[#334155] p-6 lg:p-8">
      ...
      <div className="flex flex-col sm:flex-row gap-6">
        ...
        <div className="sm:w-2/3 flex-1">
          ...
          <p className="text-[#475569] dark:text-[#CBD5E1] mb-6 text-sm lg:text-base leading-relaxed">
            {bio}
          </p>

          <div className="mb-6">
            <h4 className="font-semibold mb-3 text-[#0F172A] dark:text-white text-sm lg:text-base">
              Areas of Expertise
            </h4>
