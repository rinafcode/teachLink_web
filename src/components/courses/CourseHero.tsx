      ...
      <div className="absolute inset-0 flex items-end">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 pb-8 lg:pb-12">
          <div className="max-w-4xl">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-3 lg:mb-4 text-white leading-tight">
              {title}
            </h1>
            <p className="text-base sm:text-lg lg:text-xl mb-4 lg:mb-6 text-white/90 max-w-2xl leading-relaxed">
              {description}
            </p>
