        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between pb-4 border-b border-slate-100">
                <h2 className="text-lg font-bold font-sans text-slate-800 flex items-center gap-2">
                    {results.length} results <span className="text-slate-300 text-sm font-normal">discovered in 0.8s</span>
                </h2>
                    ...
                    >
                        ...
                        <div className="flex items-start gap-6">
                            <div className="hidden sm:flex flex-col items-center gap-2 text-slate-300">
                                ...
                                <span className="text-[8px] font-mono font-bold uppercase tracking-tighter">REP</span>
                            </div>
