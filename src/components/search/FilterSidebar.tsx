...
export const FilterSidebar = React.memo<FilterSidebarProps>(
  ({ filters, onFilterChange, onReset }) => {
      ...
      const filterGroups: StructuredDataFilterGroup[] = [
        {
          ...
          type: 'checkbox',
          options: [
            { id: 'beginner', label: 'Beginner', description: 'Entry-level content' },
            { id: 'intermediate', label: 'Intermediate', description: 'Mid-level content' },
            { id: 'advanced', label: 'Advanced', description: 'Expert-level content' },
          ],
        },
        {
          id: 'duration',
          name: 'Duration',
          description: 'Filter by maximum course duration in hours',
          type: 'range',
          options: [{ id: 'duration', label: 'Duration', value: filters.duration.toString() }],
        },
        {
          id: 'price',
          name: 'Price',
          ...
          type: 'range',
          options: [{ id: 'price', label: 'Price', value: filters.priceRange.toString() }],
        },
        {
          id: 'topics',
          name: 'Topics',
          description: 'Filter by course topics',
          type: 'multiselect',
          options: TOPIC_OPTIONS.map((topic) => ({
        ...
        },
        {
          ...
          type: 'radio',
          options: [
            { id: 'sarah-connor', label: 'Dr. Sarah Connor' },
        ...
        },
        {
          id: 'node-affinity',
          name: 'Node Affinity',
          description: 'Select target cluster node for query execution',
          type: 'radio',
          options: [
            { id: 'auto', label: 'Auto (Optimized)', description: 'Dynamic load balancing' },
            { id: 'primary', label: 'Primary Cluster', description: 'Direct consistency check' },
            { id: 'replica', label: 'Replica Node', description: 'Fast read-heavy execution' },
            { id: 'edge', label: 'Edge Cache', description: 'Minimal latency routing' },
          ],
        },
      ];
      return generateFilterStructuredData(filterGroups);
    }, [filters.duration, filters.priceRange]);
    ...
    return (
      <>
        <StructuredDataScript jsonLd={structuredData} id="filter-sidebar-structured-data" />
