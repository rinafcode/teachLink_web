...
export function TouchButton({
  ...
  const baseClasses =
    'min-h-[44px] min-w-[44px] px-6 py-3 rounded-xl font-medium active:scale-95 transition-transform touch-manipulation select-none flex items-center justify-center disabled:opacity-50 disabled:active:scale-100';
  ...
  const variants = {
    ...
    ghost:
      'bg-transparent text-gray-700 active:bg-gray-100 dark:text-gray-300 dark:active:bg-gray-800',
  };
