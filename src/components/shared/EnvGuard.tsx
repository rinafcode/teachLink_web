        ...
        <div className="max-w-md w-full bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-2xl p-8 shadow-xl text-center">
          ...
          <div className="space-y-4">
            <p className="text-sm text-gray-500">
              Please check your <code className="px-1.5 py-0.5 bg-gray-100 dark:bg-gray-800 rounded text-red-600">.env</code> file and ensure all required variables are set correctly.
            </p>
            <button
