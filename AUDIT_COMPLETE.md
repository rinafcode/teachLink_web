...
4. **`src/schemas/certificate.schema.ts`** (83 lines)
...
5. **`src/services/certificate-service.ts`** (320 lines)
...
**Tests (1 file)**
10. **`src/app/api/certificates/__tests__/certificate-security.test.ts`** (450 lines)
    - 40+ comprehensive security tests
    - T1: IDOR prevention tests
    - T2: Input sanitization tests (5 scenarios)
    - T3: Forgery/verification tests
    - T5: Rate limiting tests
    - T7: UUID format validation
    - T8: Audit logging tests
